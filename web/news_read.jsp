        ...
        <div class="content">
            <ul class="classlist">
                <table width="80%" align="center">
                    <tr width="100%">
                        <td colspan="2" align="center"><c:out value="${news.ntitle}"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td align="center"><c:out value="${news.ncreateDate}"/>
                        </td>
                        <td align="left"><c:out value="${news.nauthor}"/>
                        </td>
                    </tr>
                    <tr>
            ...
            <ul class="classlist">
                <table width="80%" align="center" id="commentstable">
                    ...
                    <c:forEach items="${news.commentsList}" var="comment">
                        <tr>
                            <td colspan="2">${comment.ccontent}</td>
                            <td colspan="2">${comment.cauthor}</td>
                            <td colspan="2">${comment.cdate}</td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                <hr/>
            ...
            <ul class="classlist">
                <form action="#" id="commentsform" method="post">
                    ...
                    <table width="80%" align="center">
                        ...
                        <tr>
                            <td> 用户名：</td>
                            <td><input id="cauthor" name="cauthor" value="<c:out value='${sessionScope.user}' default='这家伙很懒什么也没留下'/>"/>
...
<script type="text/javascript">
    $("#csubmit").click(function () {
        ...
        $.post("comments",$("#commentsform").serialize(), function (result) {
            if (result.state == 200) {
                //添加成功
                var $tr = $(" <tr>\n" +
