...
//    NewsDao newsDao = new NewsDaoImpl(null);
...
//            request.getRequestDispatcher("newspages/topic_list.jsp").forward(request, response);
            ...
            String toJSONString = JSON.toJSONString(topics);
            ...
            if (tname == null || "".equals(tname)) {
                ...
                if (count == -1) {//主题已存在
                    ...
                    if (count > 0) {
                        ...
                        out.print("<script language='javascript'>location.href='/newspages/topic_add.jsp'</script>");
                        //out.print("<script language='javascript'>alert('添加成功！') location.href = '/newspages/topic_add.jsp</script>");
                    } else {
            ...
            if (tname == null || "".equals(tname)) {
                ...
                if (count == -1) {
                    ...
                    if (count > 0) {
                        ...
                        request.getServletContext().setAttribute("topics", topics);
                        out.print("<script language='javascript'>\n alert('修改成功！');\n </script>");
                        out.print("<script language='javascript'>location.href='/newspages/topic_list.jsp'</script>");
                        //out.print("<script language='javascript> alert(修改成功！)</script>");
                        //out.print("<script language='javascript> location.href ='/newspages/topic_modify.jsp'</script>");
                    } else {
